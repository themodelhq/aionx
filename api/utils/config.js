...
console.log('[Config] PIXAZO_API_KEY:     ', maskKey(process.env.PIXAZO_API_KEY));
console.log('[Config] FISH_AUDIO_API_KEY: ', maskKey(process.env.FISH_AUDIO_API_KEY));
console.log('[Config] FISH_AUDIO_VOICE_ID:', maskKey(process.env.FISH_AUDIO_VOICE_ID));
