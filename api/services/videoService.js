...
class VideoGenerationService {
  ...
  async generate({ id, prompt, imageUrl, duration = 6, resolution = '480p', motionStyle = 'cinematic' }) {
    try {
  ...
  async generateMagicHourTextToVideo({ id, prompt, duration, resolution, motionStyle, magicHourKey }) {
    ...
    const safeResolution = validResolutions.includes(resolution) ? resolution : '480p';
